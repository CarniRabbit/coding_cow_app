...
import 'package:coding_cow_app/widgets/move_middle_to_circle_transition_route.dart';
...
class FunkyOverlayState extends State<FunkyOverlay>
  ...
  @override
  void dispose() {
    controller.dispose(); // 위젯이 제거될 때 컨트롤러를 정리합니다.
    super.dispose();
  }
            ...
            TextButton(
                onPressed: () async { // press event (확인)
                  ...
                  if (text.replaceAll(RegExp('\\s'), "") == get_problems[problem_no].answer.replaceAll(RegExp('\\s'), "")) {
                    ...
                    today_progress = get_todaySolved / today_problem_count;
                  }
